...
Checkbutton(frame, text="Con leche", variable=leche, onvalue=1, offvalue=0, command=seleccionar).pack(anchor="w") #onvalue = valor de cambia offvalue = valor por defecto
